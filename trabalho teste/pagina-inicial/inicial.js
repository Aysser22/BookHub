...
document.addEventListener('click', (event) => {
    ...
    const acao = estado === 'reservado' ? 'retirar' : 'reservar';

    atualizarPerfilDoUsuario(tituloLivro, acao);
    renderizarCatalogo();
    mostrarNotificacao(
        acao === 'reservar' ? `Reserva confirmada para “${tituloLivro}”` : `Reserva retirada para “${tituloLivro}”`,
        'sucesso'
    );
});
